...
| cargo | android_system_properties | 0.1.5 | MIT/Apache-2.0 |
...
| cargo | camino | 1.2.4 | MIT OR Apache-2.0 |
...
| cargo | displaydoc | 0.2.6 | MIT OR Apache-2.0 |
...
| cargo | fixedbitset | 0.5.7 | MIT OR Apache-2.0 |
...
| cargo | gethostname | 1.1.0 | Apache-2.0 |
...
| cargo | hashlink | 0.12.1 | MIT OR Apache-2.0 |
...
| cargo | js-sys | 0.3.103 | MIT OR Apache-2.0 |
...
| cargo | libsqlite3-sys | 0.38.1 | MIT |
...
| cargo | moyumax-core | 0.1.0-preview.1 | GPL-3.0-only |
| cargo | moyumax-desktop | 0.1.0-preview.1 | GPL-3.0-only |
...
| cargo | petgraph | 0.8.3 | MIT OR Apache-2.0 |
...
| cargo | pxfm | 0.1.29 | BSD-3-Clause OR Apache-2.0 |
...
| cargo | sqlite-wasm-rs | 0.5.5 | MIT |
...
| cargo | tao-macros | 0.1.3 | MIT OR Apache-2.0 |
...
| cargo | tauri-plugin-clipboard-manager | 2.3.2 | Apache-2.0 OR MIT |
...
| cargo | toml | 1.1.3+spec-1.1.0 | MIT OR Apache-2.0 |
...
| cargo | tree_magic_mini | 3.2.2 | MIT |
...
| cargo | vcpkg | 0.2.15 | MIT/Apache-2.0 |
...
| cargo | wasm-bindgen | 0.2.126 | MIT OR Apache-2.0 |
| cargo | wasm-bindgen-futures | 0.4.76 | MIT OR Apache-2.0 |
| cargo | wasm-bindgen-macro | 0.2.126 | MIT OR Apache-2.0 |
| cargo | wasm-bindgen-macro-support | 0.2.126 | MIT OR Apache-2.0 |
| cargo | wasm-bindgen-shared | 0.2.126 | MIT OR Apache-2.0 |
| cargo | wasm-streams | 0.5.0 | MIT OR Apache-2.0 |
| cargo | wayland-backend | 0.3.16 | MIT |
| cargo | wayland-client | 0.31.15 | MIT |
| cargo | wayland-protocols | 0.32.13 | MIT |
| cargo | wayland-protocols-wlr | 0.3.12 | MIT |
| cargo | wayland-scanner | 0.31.11 | MIT |
| cargo | wayland-sys | 0.31.11 | MIT |
| cargo | web_atoms | 0.2.5 | MIT OR Apache-2.0 |
| cargo | web-sys | 0.3.103 | MIT OR Apache-2.0 |
...
| cargo | wl-clipboard-rs | 0.9.3 | MIT/Apache-2.0 |
| cargo | writeable | 0.6.3 | Unicode-3.0 |
| cargo | wry | 0.55.1 | Apache-2.0 OR MIT |
| cargo | x11 | 2.21.0 | MIT |
| cargo | x11-dl | 2.21.0 | MIT |
| cargo | x11rb | 0.13.2 | MIT OR Apache-2.0 |
| cargo | x11rb-protocol | 0.13.2 | MIT OR Apache-2.0 |
...
| cargo | zune-core | 0.5.1 | MIT OR Apache-2.0 OR Zlib |
...
| npm | devalue | 5.8.2 | MIT |
| npm | es-module-lexer | 2.3.1 | MIT |
| npm | esm-env | 1.2.2 | MIT |
| npm | esrap | 2.3.0 | MIT |
| npm | estree-walker | 3.0.3 | MIT |
| npm | expect-type | 1.4.0 | Apache-2.0 |
| npm | fdir | 6.5.0 | 未知（平台可选，未在本机安装） |
| npm | fsevents | 2.3.2 | 未知（平台可选，未在本机安装） |
| npm | fsevents | 2.3.3 | 未知（平台可选，未在本机安装） |
| npm | is-reference | 3.0.3 | MIT |
| npm | lightningcss | 1.33.0 | MPL-2.0 |
| npm | lightningcss-android-arm64 | 1.33.0 | 未知（平台可选，未在本机安装） |
| npm | lightningcss-darwin-arm64 | 1.33.0 | 未知（平台可选，未在本机安装） |
| npm | lightningcss-darwin-x64 | 1.33.0 | 未知（平台可选，未在本机安装） |
| npm | lightningcss-freebsd-x64 | 1.33.0 | 未知（平台可选，未在本机安装） |
| npm | lightningcss-linux-arm-gnueabihf | 1.33.0 | 未知（平台可选，未在本机安装） |
| npm | lightningcss-linux-arm64-gnu | 1.33.0 | 未知（平台可选，未在本机安装） |
| npm | lightningcss-linux-arm64-musl | 1.33.0 | 未知（平台可选，未在本机安装） |
| npm | lightningcss-linux-x64-gnu | 1.33.0 | 未知（平台可选，未在本机安装） |
| npm | lightningcss-linux-x64-musl | 1.33.0 | 未知（平台可选，未在本机安装） |
| npm | lightningcss-win32-arm64-msvc | 1.33.0 | 未知（平台可选，未在本机安装） |
...
| npm | svelte | 5.56.7 | MIT |
| npm | svelte-check | 4.7.3 | 未知（平台可选，未在本机安装） |
| npm | tinybench | 2.9.0 | MIT |
| npm | tinyexec | 1.2.4 | MIT |
| npm | tinyglobby | 0.2.17 | MIT |
| npm | tinyrainbow | 3.1.0 | MIT |
| npm | tslib | 2.8.1 | 未知（平台可选，未在本机安装） |
| npm | typescript | 5.9.3 | Apache-2.0 |
| npm | vite | 8.1.5 | MIT |
| npm | vitefu | 1.1.3 | 未知（平台可选，未在本机安装） |
| npm | vitest | 4.1.10 | 未知（平台可选，未在本机安装） |
| npm | why-is-node-running | 2.3.0 | MIT |
| npm | zimmerframe | 1.1.4 | MIT |
