...
项目当前处于公开预览前的增量开发阶段。已经完成首次运行、当前推荐 Vanilla/Fabric 与 Azul Zulu 的真实安装执行、隔离实例启动、Modrinth 模组及必需依赖原子安装，以及异常退出后的本地崩溃报告和脱敏诊断包基础闭环。首个公开预览仍缺少正式账户入口、其余加载器、完整任务控制、备份与回收站、三语 i18n 和内置 CLI，因此当前构建不标记为公开预览版。
