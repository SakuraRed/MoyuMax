...
[![Release: v0.2.0](https://img.shields.io/badge/release-v0.2.0-brightgreen.svg)](#下载)
...
- CurseForge 官方源：本机 API Key 配置后浏览、搜索与安装，未配置时经 MCI Mirror 内置镜像提供
...
- 皮肤双层头像、启动身份实时展示、简/繁/英三语、深色/浅色/高对比主题、自定义背景与主题包标准 v2（内置动物森友会主题包）
...
- **[MoyuMax_0.2.0_x64-setup.exe](https://github.com/SakuraRed/MoyuMax/releases/latest)**
